...
class Snp(object):
    ...
    def __str__(self, bypos=False):
        return "{}\t{}\t{}\t{}".format(self.chrom, self.position_tag, self.cm,
                                       self.pos)
...
if __name__ == '__main__':
    ...
    report = './FinalReportTools-master/Test/FinalReport.txt'
    map_file = './FinalReportTools-master/Test/SNP_Map.txt'
    FinalReport().read_report(report)
    # FinalReport().read_map(map_file)
